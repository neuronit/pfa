...
if len(sys.argv) == 1: # no args => defines (for performance when no testing) and runs tests
    ...
    def _test__reinforcement_learning():
        ...
        #{'y': 0.26276664905448405, 'x': 0.1908486277831362, 's': 45, 'z': 0.2706882443595372}
        # without victory rewarding
        p_weights_array =     [ -1,  0.1908486277831362,  -1 ]
        p_rewards_array =     [ -1,  0.2706882443595372,   -1 ]
        p_punishs_array =     [ -1,  -0.26276664905448405,    -1 ]
        p_inner_sizes_array = [ [],  [45,1], [] ]
        ...
        # simple case
        p_types_array =       ["in", "mlp", "mlp","out"]
        p_weights_array =     [ -1,  0.18636298764849027, 0.18636298764849027,  -1 ]
        p_rewards_array =     [ -1,  0.06957097548475873, 0.06957097548475873,  -1 ]
        p_punishs_array =     [ -1,  -0.1560650012178876, -0.1560650012178876,   -1 ]
        p_inner_sizes_array = [ [],  [34,1], [], [] ]
        p_links_array =       [ [1], [2],   [3], [] ]
        ...
        save_path, was_saved, score_evolution = multi_networks (p_types_array,
                                                                p_weights_array,
                                                                p_rewards_array,
                                                                p_punishs_array,
                                                                p_inner_sizes_array,
